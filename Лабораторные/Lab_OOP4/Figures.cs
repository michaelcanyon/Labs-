...
namespace Lab_OOP4
{
    ...
    class Line : Point
    {
        ...
        public  void Show() { graph.DrawLine(newFigure, Convert.ToSingle(X + Length / 2 * System.Math.Sin(Angle)), Convert.ToSingle(Y - Length / 2 * System.Math.Cos(Angle)), Convert.ToSingle(X + Length / 2 * System.Math.Sin(Angle + System.Math.PI)), Convert.ToSingle(Y - Length / 2 * System.Math.Cos(Angle + System.Math.PI))); }
