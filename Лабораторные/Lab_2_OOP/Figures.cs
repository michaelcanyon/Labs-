...
namespace Lab_2_OOP
{
    class Point
    {
        ...
        public void Show() { graph.DrawLine(newFigure,X, Y, X + 1, Y); }
    ...
    class Line : Point
    {
        ...
        public new void Move(int DX)
        {
            Hide();
            X += DX;
            Show();
        }
        public new void Show() { graph.DrawLine(newFigure, Convert.ToSingle(X + Length / 2 * System.Math.Sin(Angle)), Convert.ToSingle(Y - Length / 2 * System.Math.Cos(Angle)), Convert.ToSingle(X + Length / 2 * System.Math.Sin(Angle + System.Math.PI)), Convert.ToSingle(Y - Length / 2 * System.Math.Cos(Angle + System.Math.PI))); }
    ...
    class Parallelogram : Line
    {
        ...
        public new void Rotate(double dx)
        {
            Hide();
            Angle += dx;
            Show();
